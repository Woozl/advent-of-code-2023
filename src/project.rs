// ALL credit for this file goes to https://github.com/rust-lang/rustlings
...
impl RustAnalyzerProject {
    ...
    // MODIFIED for AOC challenges folder

    /// Parse the challenges folder for .rs files, any matches will create
    /// a new `crate` in rust-project.json which allows rust-analyzer to
    /// treat it like a normal binary
    pub fn challenges_to_json(&mut self) -> Result<(), Box<dyn Error>> {
        for path in glob("./challenges/**/*")? {
